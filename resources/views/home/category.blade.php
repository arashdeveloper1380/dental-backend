...
@section('desc')<meta name="description" content="{{ $categoryBlog->meta_desc }}"/> @endsection
@section('keywords')<meta name="keywords" content="{{ $categoryBlog->meta_keywords }}"/> @endsection
...
<section class="ftco-section bg-light">
    <div class="container">
        <div class="row">
            @foreach($categoryBlog->blog as $value)
